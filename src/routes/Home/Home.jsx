...
const ToolIcon = memo(() => (
  <svg className={s.featureIcon} viewBox="0 0 24 24" fill="none">
    <path 
...
const REVIEWS = [
  { 
    stars: 5, 
    text: "Отличный магазин, всё пришло вовремя. Инструменты качественные и надёжные." 
  },
  { 
    stars: 4, 
    text: "Хороший выбор и адекватные цены. Единственное — хотелось бы быстрее доставку." 
  },
  { 
    stars: 5, 
    text: "Магазин супер! Очень дружелюбный персонал и быстрое обслуживание." 
  }
];
...
export const Home = memo(() => {
  ...
  useScrollAnimation([lineRef, aboutRef, heroRef, featuresRef, reviewsRef]);
